...
<div class="row my-3">
    <div class="col">
        <a href="<?= route_to('jadwal.export.pdf', 'UTS') ?>" target="_blank" class="btn btn-warning">Export PDF</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <a href="<?= route_to('export.reguler.excel', 'UTS') ?>" class="btn btn-primary">Export Semua</a>
